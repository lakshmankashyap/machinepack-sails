module.exports = {
  ...
  friendlyName: 'Log (warn)',


  description: 'Write a "warn"-level message to the Sails log.',


  extendedDescription: 'The Sails log typically outputs "warn"-level messages directly to stdout, but this can be configured using ' +
  ...
  fn: function(inputs, exits, env) {
    ...
    // Log using the "warn" level.
    env.sails.log.warn(inputs.value);
